...
export declare const ARXIV_API_BASE_URL = "https://export.arxiv.org/api/query";
...
export declare const ANTHROPIC_RATE_LIMIT_MS = 200;
/** Anthropic jitter minimum: 50ms */
export declare const ANTHROPIC_JITTER_MIN_MS = 50;
